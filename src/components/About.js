        ...
        <div className="mx-auto flex lg:flex-row flex-col items-center justify-center">
          ...
          <div className="lg:w-1/2 justify-center lg:p-5 xl:p-7 md:p-5 flex flex-col items-center text-justify">
            ...
            >
              ...
              well-versed in popular libraries such as React and framework like
              Tailwind allowing me to build robust and responsive websites.{" "}
              <br /> <br /> I'm excited to take on new challenges and contribute
              to innovative projects. Feel free to connect with me through my
              social handles.
            </p>
            <div
              data-aos="zoom-in"
            ...
            >
              ...
              <a
                href="https://drive.google.com/file/d/1xnCG2XC8N_GVLovhdB2rAROBOV7T7s4V/view?usp=sharing"
                target="_blank"
                rel="noreferrer"
              >
